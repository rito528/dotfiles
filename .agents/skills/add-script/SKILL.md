...
[`install/`](../../../install/) 配下に冪等なセットアップ用シェルスクリプトを追加し、必要に応じて [`setup.sh`](../../../setup.sh) に組み込む。

## 手順

### 1. 配置先を決める

- [`install/common/`](../../../install/common/): OS に依存しない処理
- [`install/ubuntu/`](../../../install/ubuntu/): Ubuntu / Debian 固有の処理
...
セットアップフローに含める場合は該当する [`setup.sh`](../../../setup.sh) に追記する。
